...
<div align="center">
	...
	<img width="300" src="images/shield4.jpg">
	<img width="300" src="images/shield2.jpg">
</div>
...
<div align="center">
        <img width="550" src="images/shieldA.jpg">
</div>
...
<div align="center">
        <img width="750" src="images/ppe-slideshow.gif">
</div>
...
6. **IMPORTANT!** Record your donation using [this form](https://docs.google.com/forms/d/e/1FAIpQLSeufs_A6_XCnf65XNlsDAwN6ECZPi3XLqRlp83tyoBMacYtQw/viewform), maintained by [aceat64](https://github.com/aceat64).
...
Find the right group that works for you! Other DFW PPE initiatives include the following:

[ACME Creation Lab](https://www.acmecreationlab.org/) is leading an initiative to safely produce PPE using their shared community workshop. Click [here](https://forms.gle/5DQuzs4wFgVawN4t7) to become one of the on-site community volunteers. They can also be found [here](https://www.meetup.com/Open-Source-PPE-Makers/) on the Open Source PPE Makers Meetup group.
...
- Special thanks goes to Dallas Makerspace Blacksmithing Chair, Mike Churchill, for being the first to [propose](https://talk.dallasmakerspace.org/t/nih-approved-3d-printable-face-shields/70470) this project.
- And a very special thank you goes out to former Dallas Makerspace President [Andrew LeCody](https://github.com/aceat64) for starting and managing this initiative. The source branch for his project, as well as any updates not found on this page can be found [here](https://github.com/aceat64/ppe-donations).
